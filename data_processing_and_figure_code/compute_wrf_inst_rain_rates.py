#==========================================================================
# Title: compute_wrf_inst_rain_rates.py
# Author: McKenna W. Stanford
# Utility: Reads in dictionaries named <SIM_NAME>_rain_vars_at_2.5-km.p
...
for sim_ii in range(num_sims):
    ...
    pkl_file = open(path+'rain_vars/'+sim_names[sim_ii]+'_rain_vars_at_2.5-km.p','rb')
    ...
    rhofacr = (rhosur/rain_vars_dict['rho_air'][48:])**0.54   
    
    qr = rain_vars_dict['qr'][48:,:,:]
    nr = rain_vars_dict['nr'][48:,:,:]
    rho_air = rain_vars_dict['rho_air'][48:,:,:]
    time = rain_vars_dict['time_arr'][48:]
    ...
    f = open(savdir+sim_names[sim_ii]+'_inst_rain_rates.p','wb')
