#==========================================================================
# Title: compute_updraft_nearest_neighbor_distances.py
...
for sim_ii in range(num_sims):
    ...
    files = sorted(glob.glob(path+sim_names[sim_ii]+'/wrfout*'))[48:]
    nt = len(files)
    ...
    for tt in range(nt):
        ...
        z = wrf.getvar(ncfile,'height',meta=False).data.T
    ...
    f = open(savdir+sim_names[sim_ii]+'_updraft_nearest_neighbor.p','wb')
