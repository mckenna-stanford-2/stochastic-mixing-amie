#==========================================================================
# Title: coarse_grain_1km_acc_gridscale_precip.py
# Author: McKenna Stanford
# Utility: Coarse-grains accumulated gridscale precip from 1-km simulation to
#  3-km grid spacing.
#==========================================================================
...
pkl_file = open(path+'baesline_1km_acc_gridscale_precip.p','rb')
...
f = open(savdir+'baseline_1km_CG_acc_gridscale_precip.p','wb')
