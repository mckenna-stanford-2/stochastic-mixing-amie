#==========================================================================
# Title: compute_conv_strat_regions_1km_CG.py
# Author: McKenna W. Stanford
# Utility: Computes convective and stratiform regions for the coarse-grained
# 1-km baselne simulation following algorithm
# of Steiner et al. (1995) and saves masks, dbz, and rain rates @ 2.5 km
# AGL to a dictionary named baseline_1km_cg_conv_strat_id.p'
#==========================================================================
...
files = sorted(glob.glob(path+'baseline_1km/3km/wrfout_d02*coarse_grained_to_3km.nc'))
nt = len(files)
#print(files)
print(nt)
...
#----------------------------------------------
pkl_file = open(path+'amie_post/inst_rain_rates/baseline_1km_CG_inst_rain_rates.p','rb')
...
for tt in range(nt):
    ...
    dbz_2pt5km = dbz[:,:,nearest_id]
    #z_2pt5km = z[:,:,nearest_id]
...
f = open(savdir+'baseline_1km_CG_conv_strat_id.p','wb')
